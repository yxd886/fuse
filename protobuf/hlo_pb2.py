...
import xla_data_pb2 as xla__data__pb2
...
_HLOINSTRUCTIONPROTO.fields_by_name['shape'].message_type = xla__data__pb2._SHAPEPROTO
_HLOINSTRUCTIONPROTO.fields_by_name['metadata'].message_type = xla__data__pb2._OPMETADATA
_HLOINSTRUCTIONPROTO.fields_by_name['literal'].message_type = xla__data__pb2._LITERALPROTO
_HLOINSTRUCTIONPROTO.fields_by_name['window'].message_type = xla__data__pb2._WINDOW
_HLOINSTRUCTIONPROTO.fields_by_name['convolution_dimension_numbers'].message_type = xla__data__pb2._CONVOLUTIONDIMENSIONNUMBERS
_HLOINSTRUCTIONPROTO.fields_by_name['slice_dimensions'].message_type = _HLOINSTRUCTIONPROTO_SLICEDIMENSIONS
_HLOINSTRUCTIONPROTO.fields_by_name['padding_config'].message_type = xla__data__pb2._PADDINGCONFIG
_HLOINSTRUCTIONPROTO.fields_by_name['distribution'].enum_type = xla__data__pb2._RANDOMDISTRIBUTION
_HLOINSTRUCTIONPROTO.fields_by_name['outfeed_shape'].message_type = xla__data__pb2._SHAPEPROTO
_HLOINSTRUCTIONPROTO.fields_by_name['dot_dimension_numbers'].message_type = xla__data__pb2._DOTDIMENSIONNUMBERS
_HLOINSTRUCTIONPROTO.fields_by_name['fft_type'].enum_type = xla__data__pb2._FFTTYPE
_HLOINSTRUCTIONPROTO.fields_by_name['gather_dimension_numbers'].message_type = xla__data__pb2._GATHERDIMENSIONNUMBERS
_HLOINSTRUCTIONPROTO.fields_by_name['sharding'].message_type = xla__data__pb2._OPSHARDING
_HLOINSTRUCTIONPROTO.fields_by_name['replica_groups'].message_type = xla__data__pb2._REPLICAGROUP
_HLOINSTRUCTIONPROTO.fields_by_name['scatter_dimension_numbers'].message_type = xla__data__pb2._SCATTERDIMENSIONNUMBERS
_HLOINSTRUCTIONPROTO.fields_by_name['precision_config'].message_type = xla__data__pb2._PRECISIONCONFIG
_HLOINSTRUCTIONPROTO.fields_by_name['source_target_pairs'].message_type = xla__data__pb2._SOURCETARGET
_HLOINSTRUCTIONPROTO.fields_by_name['domain_entry_sharding'].message_type = xla__data__pb2._OPSHARDING
_HLOINSTRUCTIONPROTO.fields_by_name['domain_exit_sharding'].message_type = xla__data__pb2._OPSHARDING
_HLOINSTRUCTIONPROTO.fields_by_name['operand_shapes_with_layout'].message_type = xla__data__pb2._SHAPEPROTO
_HLOINSTRUCTIONPROTO.fields_by_name['triangular_solve_options'].message_type = xla__data__pb2._TRIANGULARSOLVEOPTIONS
_HLOINSTRUCTIONPROTO.fields_by_name['cholesky_options'].message_type = xla__data__pb2._CHOLESKYOPTIONS
_HLOINSTRUCTIONPROTO.fields_by_name['parameter_replication'].message_type = xla__data__pb2._PARAMETERREPLICATION
_HLOINSTRUCTIONPROTO.fields_by_name['custom_call_output_operand_aliasing'].message_type = xla__data__pb2._CUSTOMCALLOUTPUTOPERANDALIASING
_HLOINSTRUCTIONPROTO.fields_by_name['frontend_attributes'].message_type = xla__data__pb2._FRONTENDATTRIBUTES
_HLOINSTRUCTIONPROTO.fields_by_name['rng_algorithm'].enum_type = xla__data__pb2._RANDOMALGORITHM
_HLOCOMPUTATIONPROTO.fields_by_name['instructions'].message_type = _HLOINSTRUCTIONPROTO
_HLOCOMPUTATIONPROTO.fields_by_name['program_shape'].message_type = xla__data__pb2._PROGRAMSHAPEPROTO
...
_HLOMODULEPROTO.fields_by_name['host_program_shape'].message_type = xla__data__pb2._PROGRAMSHAPEPROTO
...
_HLOSNAPSHOT.fields_by_name['arguments'].message_type = xla__data__pb2._LITERALPROTO
_HLOSNAPSHOT.fields_by_name['result'].message_type = xla__data__pb2._LITERALPROTO
